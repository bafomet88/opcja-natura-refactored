...
function P24Logo(props) {
  return (
    ...
    >
      ...
      <path
        className="prefix__st0"
        d="M-22.8 291.5c-5.2 0-10.2 2.1-14.4 4.4l.7-4.4h-13.8l-11.1 62.6h13.9l6.1-34.7c1.3-7 6.5-15.7 16.8-15.7h7.2l2.2-12.2h-7.6z"
      />
    </svg>
  )
}

const MemoP24Logo = React.memo(P24Logo)
